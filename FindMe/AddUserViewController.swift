...
//, UISearchControllerDelegate, UISearchResultsUpdating, UITableViewDelegate, UITableViewDataSource
{
...
//                            if !(self.friendBook.contains(objectID)) {
